...
public class FileConfig {
	public static void main(String[] args) {
		packageClassData("C:\\wepDev\\webStudy\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\JSPFrontProject_4\\WEB-INF\\classes", "com.sist.model");
	}
	public static List<String> packageClassData(String path,String pack) {
		...
		try {
			...
			for(File f:listFiles) {
				...
				if(ext.equals("class") && !name.startsWith("Model.class")) {
